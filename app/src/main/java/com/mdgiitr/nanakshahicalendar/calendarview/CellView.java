package com.mdgiitr.nanakshahicalendar.calendarview;
...
public class CellView extends BaseCellView {
        ...
        private void init(){
            radius = (int)getResources().getDimension(R.dimen.cell_view_event_radius);
            padding = (int)getResources().getDimension(R.dimen.cell_view_event_spacing);
        }
